...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "You can download my CV through the PDF button on the top right (last updated - September 1st, 2025).",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-five-papers-accepted-to-cogsci-2025",
          title: 'Five papers accepted to CogSci 2025!',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=h-pwCMUAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/RajaMarjieh", "_blank");
        },
      },{
      id: 'light-theme',
